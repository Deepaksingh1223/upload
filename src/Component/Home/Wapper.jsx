...
const Sectionthree = () => {
    return (
        <>
            <div className="overflow-hidden position-relative space overflow-hidden" id="about-sec">
                <div className="container">
                    <div className="row gx-100 gy-60 align-items-center">
                        <div className="col-xxl-6 col-xl-6">
                            <div className="img-box2" data-aos="fade-left">
                                <div className="img1">
                                    <img src={Image.aboutimgPNG} alt="About" /></div>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6">
                            <div className="about-wrap2">
                                <div className="title-area mb-35">
                                    <span className="sub-title2 mb-30 text-anim text-white" data-aos="fade-Up">About Us</span>
                                    <h2 className="sec-title style2 text-anim2 text-white" data-aos="fade-Up">Empower Your Business With Real-Time Intelligence</h2>
                                </div>
                                <p className="sec-text text-gray3 mb-25" aos-cue="fade-Up">
                                    Artificial Intelligence (AI) technology refers to the simulation of human intelligence in machines that are programmed to think, learn, and make decisions. AI technology leverages data, algorithms, and computing power to automate tasks.</p>
                                <div className="checklist style4" data-aos="fade-Up">
                                    <ul>
                                        ...
                                        <li>
                                            <img src={Image.checkicon1} alt="img" />
                                            Real-time Data Analysis and Monitoring for Optimized Performance.</li>
                                        <li>
                                            <img src={Image.checkicon1} alt="img" />
                                            Collaborative and Autonomous Robots for Seamless Integration</li>
                                    </ul>
                                </div>
...
const BrandSlider = () => {
    ...
    return (
        ...
        <div className="overflow-hidden brand-area-2 position-relative z-index-2"
        ...
        <>
            <div id="hero" className="th-hero-wrapper hero-2">
                <div
                    ...
                    style={{ backgroundImage: `url(${Image.herobg})` }}></div>
                <div className="hero-inner">
                        ...
                        <div className="row justify-content-center">
                            <div className="col-xl-9 col-lg-10">
                                <div className="hero-style2 text-center">
                                    ...
                                    <h1 className="hero-title text-white" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <div className="btn-wrap justify-content-center" data-aos="fade-up" data-aos-delay="500">
                                        ...
                                        <a href="/" className="th-btn style-border2">
                                            Discover More <i className="far fa-long-arrow-right ms-2"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="hero-category-wrap" data-aos="zoom-out-up" data-aos-delay="100">
