                    ...
                    <div className="title-area text-xl-start text-center">
                        <div className="row justify-content-between align-items-center">
                            <div className="col-xl-auto">
                                <h1 className="sec-title text-anim2 text-gradient innovations-taxt aos-init aos-animate"
                                    data-aos="fade-left">Unlock the Potential <br></br> of Web3 Finance</h1>
                            </div>
                            <div className="col-md d-none d-xl-block">
                                <hr className="title-line bg-black3 mb-0" />
                            </div>
                            <div className="col-xl-5">
                                <p className="sec-title text-anim2 mb-0 chng-clr-fnt"
                                    data-aos="fade-right">
                                    Boost your business operations with Inno’s innovative Web3 platform, combining security, efficiency, and transparency.</p>
                            </div>
                        </div>
                    </div>
                    <div className="row gy-4 justify-content-center" data-aos="fade-up">
                        ...
                        <div className="col-md-4 mt-3" data-aos="fade-up">
                             <div className="card-new-design">
                                ...
                                <div className="card-sub-heading">
                                    <span>Reduce costs by streamlining operational processes.</span>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4 mt-3" data-aos="fade-up">
                             <div className="card-new-design">
                                ...
                                <div className="card-sub-heading">
                                    <span>Efficient, fast transactions without intermediaries.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4 mt-3" data-aos="fade-up">
                             <div className="card-new-design">
                                ...
                                <div className="card-sub-heading">
                                    <span>Blockchain guarantees full transaction visibility.</span>
                                </div>
                            </div>
                        </div>
                    </div>
