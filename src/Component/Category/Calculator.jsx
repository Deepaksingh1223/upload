      ...
      <div className="container-fluid p-0">
        <div className="why-wrap3">
          <div className="why-box3-1">
            <div className="img1" style={{ backgroundImage: `url(${Image.whythumbshape3}) ` }}>
              <img src={Image.whythumbshape1} alt="img" />
            </div>
            <div className="img2" style={{ backgroundImage: `url(${Image.whythumbshape3}) ` }}>
              <img src={Image.whythumbshape2} alt="img" />
            </div>
          </div> 
          <div className="why-wrap-content" style={{ backgroundColor: "#000000" }}>
            ...
            <div className="why-content">
              <div className="title-area">
                ...
                <h2
                  ...
                  data-aos="fade-up">
                  Empowering Businesses with Cutting-Edge AI Solutions to Drive Innovation.
                </h2>
                <p data-aos="fade-up" className="text-white-50">
                  Our AI agency is a cutting-edge technology partner that specializes in
                  delivering artificial intelligence solutions to help businesses streamline
                  operations, improve decision-making, and enhance customer experiences. By
              ...
              <div className="why-feature-wrap3">
                <div className="why-feature-card" data-aos="fade-up">
                  ...
                  <p className="box-text text-white-50">
                    Our team has extensive experience in building and deploying AI solutions
                ...
                <div className="why-feature-card" data-aos="fade-up">
                  ...
                  <p className="box-text text-white-50">
                    We offer tailor-made solution designed to address your unique business
                    challenges. various industries.
                  </p>
                </div>
                ...
                <div className="why-feature-card" data-aos="fade-up">
                  ...
                  <p className="box-text text-white-50">
                    We stay ahead of the curve by adopting the latest AI advancements &
