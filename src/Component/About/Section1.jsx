              ...
              <div className="about-wrap4">
                <div className="title-area mb-30">
                  ...
                  <p className="mt-15" data-aos="slide-up" data-aos-delay="400">
                    We begin by understanding your business goals, challenges, and opportunities for AI
                    integration. Our experts assess your current systems and identify areas where AI can
                    bring the most impact. Our team designs a tailor-made AI solution based on your specific
                    requirements. We develop machine learning models, build algorithms, and create prototypes
                    to ensure the solution aligns with your business objectives.
                  </p>
                </div>
...
></div>  
                    ...
                    <div className="media-body">
                      <h4 className="box-title text-white">100% Customers Satisfaction</h4>
                      <p className="box-text">
                        We bring a team of experienced AI specialists, data scientists, and industry experts
                        committed to pushing.
                      </p>
                    </div>
                  </div>

                  <div className="about-feature-card" data-aos="slide-up" data-aos-delay="300">
                    <div className="box-icon">
                      <div className="color-masking">
                      <div
  className="feature-icon"
...
></div> 
                    ...
                    <div className="media-body">
                      <h4 className="box-title text-white">Quality Assurance Guarantee</h4>
                      <p className="box-text">
                        We bring a team of experienced AI specialists, data scientists, and industry experts
                        committed to pushing.
                      </p>
